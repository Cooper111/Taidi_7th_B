...
# sum_tumor = 0
#part1
for i in range(1,87): # 前86个人作为测试集
	if i == 16:
		continue
...
#===================================================
#part4 接part3
# dataset = HDF5DatasetWriter(image_dims=(854, 512, 512, 1),
#                             mask_dims=(854, 512, 512, 1),
...
dataset = HDF5DatasetWriter(image_dims=(full_images.shape[0], full_images.shape[1], full_images.shape[2], 1),
                            mask_dims=(full_images.shape[0], full_images.shape[1], full_images.shape[2], 1),
                            outputPath=outputPath)
